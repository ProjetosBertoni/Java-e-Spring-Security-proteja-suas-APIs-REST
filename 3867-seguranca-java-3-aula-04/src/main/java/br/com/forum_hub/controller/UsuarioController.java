...
public class UsuarioController {
    ...
    public ResponseEntity<DadosListagemUsuario> adicionarPerfil(@PathVariable Long id, @RequestBody @Valid DadosPerfil dadosPerfil){
        var usuario = usuarioService.adicionarPerfil(id, dadosPerfil);
        return ResponseEntity.ok(new DadosListagemUsuario(usuario));
    }

    @PatchMapping("remover-perfil/{id}")
    public ResponseEntity<DadosListagemUsuario> removerPerfil(@PathVariable Long id, @Valid DadosPerfil dadosPerfil){
        var usuario = usuarioService.removerPerfil(id, dadosPerfil);
        return ResponseEntity.ok(new DadosListagemUsuario(usuario));
    }
}
